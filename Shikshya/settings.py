...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '*', '192.168.1.104','192.168.1.101','192.168.18.237','161.35.116.6','192.168.1.115','161.35.116.6','https://swiftlyftlogistic.com']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'Shikshya.context_processors.base_url'
            ],
        },
    },
]
